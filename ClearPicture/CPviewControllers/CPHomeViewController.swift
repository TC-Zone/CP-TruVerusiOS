...
class CPHomeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {

    var imageArray = [UIImage(named: "shoe"),UIImage(named: "tea"), UIImage(named: "nike"), UIImage(named: "shoe"), UIImage(named: "shoe4")]
